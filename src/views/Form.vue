                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="form-select" id="sender_country" v-model="data.sender_country">
                        ...
                        <option value="CG">Congo, Republic of the
                        </option>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="receiver_street" class="form-label">Street </label>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="number" class="form-control" id="receiver_zip" placeholder="Zip"
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="form-select" id="receiver_state" v-model="data.receiver_state">
                        ...
                        <option value="APO">Army Post Office (APO)
                        </option>
                        ...
                        <option value="CT">Connecticut (CT)
                        </option>
                        <option value="DC">District Of Columbia (DC)
                        </option>
                        <option value="DE">Delaware (DE)
                        </option>
                        <option value="FL">Florida (FL)
                        </option>
                        <option value="GA">Georgia (GA)
                        </option>
                        ...
                        <option value="MA">Massachusetts (MA)
                        </option>
                        ...
                        <option value="NH">New Hampshire (NH)
                        </option>
                        ...
                        <option value="AB">Alberta (AB)
                        </option>
                        <option value="BC">British Columbia (BC)
                        </option>
                        <option value="MB">Manitoba (MB)
                        </option>
                        <option value="NB">New Brunswick (NB)
                        </option>
                        <option value="NL">Newfoundland and Labrador (NL)
                        </option>
                        <option value="NS">Nova Scotia (NS)
                        </option>
                        <option value="NT">Northwest Territories (NT)
                        </option>
                        <option value="NU">Nunavut (NU)
                        </option>
                        <option value="ON">Ontario (ON)
                        </option>
                        <option value="PE">Prince Edward Island (PE)
                        </option>
                        <option value="QC">Quebec (QC)
                        </option>
                        <option value="SK">Saskatchewan (SK)
                        </option>
                        <option value="YT">Yukon (YT)
                        </option>
                      </select>
